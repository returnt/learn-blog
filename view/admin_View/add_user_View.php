...
<form method="POST" >
    ...
    <div style="width: 270px; float: left; padding-left: 50px;">
        ...
        <label style="padding-top: 7px">Пароль</label> <input class="form-control" type="text" name="password" ><div style="font-size: 8pt; color: red;"><?php echo $data['error_password'];  ?></div>
        <label style="padding-top: 7px">Повторите пароль</label> <input class="form-control" type="text" name="akcept_password"><div style="font-size: 8pt; color: red;"><?php echo $data['error_akcept_password']; ?></div>
