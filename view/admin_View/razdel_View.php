...
<form method="post">
    <label>Название тарифа</label> <input type="text" name="chat_tarif_name">
    <label>Описание тарифа</label> <input type="text" name="chat_tarif_desc">
    ...
    <table border="1" width="1000" >
        ...
        <?php foreach($data['tarif'] as $val){ ?>
            <tr>
                <td style="text-align: center;"><input type="checkbox" name="chec[]" value="<?php echo $val['chat_tarif_id'] ?>"></td>
                <td><?php echo $val['chat_tarif_id'] ?></td>
                <td><?php echo $val['chat_tarif_name'] ?></td>
