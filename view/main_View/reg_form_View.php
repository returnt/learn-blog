...
<div class="col-md-6">
<h1 style="text-align: center">Регистрация</h1><hr>
    <form method="POST" >
        ...
        <div style="width: 270px; float: left; padding-left: 50px;">
            <label style="padding-top: 7px">E-mail</label> <input class="form-control" type="text" name="email" value="<?php echo (isset($_GET['mail']))? $_GET['mail'] : $data['email']; ?>"><div style="font-size: 8pt; color: red;"><?php echo $data['error_email']; ?></div>
